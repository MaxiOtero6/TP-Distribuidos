...
func (m *Mapper) delta1Stage(data []*protocol.Delta_1_Data) (tasks Tasks) {
	...
	tasks[m.infraConfig.GetReduceExchange()][DELTA_STAGE_2] = make(map[string]*protocol.Task)
	...
	for id, data := range delta2Data {
		tasks[m.infraConfig.GetReduceExchange()][DELTA_STAGE_2][id] = &protocol.Task{
...
func (m *Mapper) eta1Stage(data []*protocol.Eta_1_Data) (tasks Tasks) {
	tasks = make(Tasks)
	tasks[m.infraConfig.GetReduceExchange()] = make(map[string]map[string]*protocol.Task)
	tasks[m.infraConfig.GetReduceExchange()][ETA_STAGE_2] = make(map[string]*protocol.Task)
	...
	for id, data := range eta2Data {
		tasks[m.infraConfig.GetReduceExchange()][ETA_STAGE_2][id] = &protocol.Task{
...
func (m *Mapper) kappa1Stage(data []*protocol.Kappa_1_Data) (tasks Tasks) {
	tasks = make(Tasks)
	tasks[m.infraConfig.GetReduceExchange()] = make(map[string]map[string]*protocol.Task)
	tasks[m.infraConfig.GetReduceExchange()][KAPPA_STAGE_2] = make(map[string]*protocol.Task)
	...
	for id, data := range kappa2Data {
		tasks[m.infraConfig.GetReduceExchange()][KAPPA_STAGE_2][id] = &protocol.Task{
...
func (m *Mapper) nu1Stage(data []*protocol.Nu_1_Data) (tasks Tasks) {
	tasks = make(Tasks)
	tasks[m.infraConfig.GetReduceExchange()] = make(map[string]map[string]*protocol.Task)
	tasks[m.infraConfig.GetReduceExchange()][NU_STAGE_2] = make(map[string]*protocol.Task)
	...
	for id, data := range nu2Data {
		tasks[m.infraConfig.GetReduceExchange()][NU_STAGE_2][id] = &protocol.Task{
