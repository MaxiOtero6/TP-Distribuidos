...
func (r *Reducer) delta3Stage(data []*protocol.Delta_3_Data, clientId string) (tasks Tasks) {
	...
	err := utils.SaveDataToFile(dirPath, clientId, DELTA_STAGE_3, dataMap)
	if err != nil {
...
func (r *Reducer) eta3Stage(data []*protocol.Eta_3_Data, clientId string) (tasks Tasks) {
	...
	dirPath := r.GetWorkerDirectory()
	err := utils.SaveDataToFile(dirPath, clientId, ETA_STAGE_3, dataMap)
	if err != nil {
...
func (r *Reducer) kappa3Stage(data []*protocol.Kappa_3_Data, clientId string) (tasks Tasks) {
	...
	dirPath := r.GetWorkerDirectory()
	err := utils.SaveDataToFile(dirPath, clientId, KAPPA_STAGE_3, dataMap)
	if err != nil {
...
func (r *Reducer) nu3Stage(data []*protocol.Nu_3_Data, clientId string) (tasks Tasks) {
	...
	dirPath := r.GetWorkerDirectory()
	err := utils.SaveDataToFile(dirPath, clientId, NU_STAGE_3, dataMap)
	if err != nil {
...
func (r *Reducer) GetWorkerDirectory() string {
	return r.infraConfig.GetWorkerDirectory(string(ReducerAction), r.infraConfig.GetNodeId())
}
