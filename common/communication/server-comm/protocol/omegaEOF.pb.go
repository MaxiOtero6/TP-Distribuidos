...
type OmegaEOF_Data struct {
	...
	EofType         string                 `protobuf:"bytes,4,opt,name=eofType,proto3" json:"eofType,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *OmegaEOF_Data) GetWorkerCreatorId() string {
	if x != nil {
		return x.WorkerCreatorId
	}
	return ""
}
...
const file_proto_stages_omegaEOF_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/stages/omegaEOF.proto\"\xaf\x01\n" +
	"\bOmegaEOF\x12\"\n" +
	"\x04data\x18\x01 \x01(\v2\x0e.OmegaEOF.DataR\x04data\x1a\x7f\n" +
	"\x04Data\x12\x1b\n" +
	"\tclient_id\x18\x01 \x01(\tR\bclientId\x12\x14\n" +
	"\x05stage\x18\x02 \x01(\tR\x05stage\x12*\n" +
	"\x11worker_creator_id\x18\x03 \x01(\tR\x0fworkerCreatorId\x12\x18\n" +
	"\aeofType\x18\x04 \x01(\tR\aeofTypeB+Z)common/communication/server-comm/protocolb\x06proto3"
